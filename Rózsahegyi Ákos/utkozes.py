...
balloon_surf = pygame.image.load("Rózsahegyi Ákos/img/balloon.png").convert_alpha()
balloon_rect = balloon_surf.get_rect(center=(WIDTH - 100, HEIGHT / 2))

bird_fw_1 = pygame.image.load("Rózsahegyi Ákos/img/bird1.png").convert_alpha()
bird_fw_2 = pygame.image.load("Rózsahegyi Ákos/img/bird2.png").convert_alpha()
bird_fw_3 = pygame.image.load("Rózsahegyi Ákos/img/bird3.png").convert_alpha()
bird_fw_4 = pygame.image.load("Rózsahegyi Ákos/img/bird4.png").convert_alpha()
birds_fw = [bird_fw_1, bird_fw_2, bird_fw_3, bird_fw_4]
bird_b_1 = pygame.image.load("Rózsahegyi Ákos/img/bird1back.png").convert_alpha()
bird_b_2 = pygame.image.load("Rózsahegyi Ákos/img/bird2back.png").convert_alpha()
bird_b_3 = pygame.image.load("Rózsahegyi Ákos/img/bird3back.png").convert_alpha()
bird_b_4 = pygame.image.load("Rózsahegyi Ákos/img/bird4back.png").convert_alpha()
